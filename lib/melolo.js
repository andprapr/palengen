...
const meloloLatest = async () => {
  try {
    ...
    const normalizedBooks = books.map(book => ({
      ...book,
      book_id: book.search_source_book_id || book.book_id, // Map search_source_book_id ke book_id
...
const meloloDetail = async (seriesId) => {
  try {
    ...
    const data = {
      ...
      series_id: seriesId, // series_id adalah search_source_book_id dari list/search
    };
...
const meloloLinkStream = async (videoId) => {
  try {
    ...
    const data = {
      ...
      video_id: videoId // video_id dari episode (vid property)
    };
